...
| Stripe / payment approval | P3-6 | Partially answered by P3-6c and webhook foundation added by P3-6d; still open for exact final values, named owners, test refs/price IDs, smoke approval, checkout/portal approval, billing-state mutation design, and live-mode approval |
