...
| **P3-5** | Real sending / provider integration | real provider integration — **DEFERRED** | **STOP GATE.** Requires written owner approval **and**: provider choice, counsel-approved legal language, SMS legal wording, SPF/DKIM/DMARC, real suppression sync, bounce/complaint webhooks. Not started until all recorded. |
...
Suggested execution order: P3-1 → P3-2 → P3-4 (design) → P3-3 (if approved) → P3-7, with P3-5
and P3-6 only after their stop gates clear.
