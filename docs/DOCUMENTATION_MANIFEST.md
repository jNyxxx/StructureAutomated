...
| First-paying-client production billing | P3-6a packet, P3-6b readiness contract, and P3-6c safe defaults created; still needs final values, named owners, test refs/price IDs, smoke approval, and live-mode approval before implementation | First paying client | BILLING / ADR_BILLING |
