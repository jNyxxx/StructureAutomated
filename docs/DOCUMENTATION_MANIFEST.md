...
| First-paying-client production billing | P3-6a packet and P3-6b readiness contract created; still needs owner answers for provider/mode/pricing/entitlements/webhooks/dunning/owners before implementation | First paying client | BILLING / ADR_BILLING |
